-- ============================================================================
-- Fraud Service — local profile sample seed data
-- Only loaded when spring.profiles.active=local (see application.yml
-- spring.flyway.locations override for the "local" profile).
-- ============================================================================
