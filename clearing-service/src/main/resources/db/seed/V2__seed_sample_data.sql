-- =====================================================================
-- Clearing Service - local-profile sample seed data
-- Applied ONLY when the "local" Spring profile is active (see
-- application.yml, spring.flyway.locations under the local profile
-- document, which appends classpath:db/seed to the migration path).
-- All ids are fixed/deterministic so API_TESTING.md examples are
-- reproducible against a freshly-seeded local database.
-- =====================================================================
