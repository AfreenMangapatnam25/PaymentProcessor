...
{
  "dataset": "fees",
  "dimensions": ["connector", "card_brand"],
  "measures": [{ "column": "fee_minor", "aggregation": "SUM" }],
  "filters": [{ "column": "currency", "op": "EQ", "values": ["USD"] }],
  "fromDate": "2026-06-01",
  "toDate": "2026-06-30",
  "orderBy": [{ "by": "sum_fee_minor", "desc": true }],
  "limit": 100
}
```
...
Swagger: http://localhost:8085/swagger-ui.html · MailHog: http://localhost:8025
...
The `pom.xml` uses `spring-boot-starter-parent` so the module builds standalone. To
fold it back into `payment-processor-platform`, swap the `<parent>` block (see the
